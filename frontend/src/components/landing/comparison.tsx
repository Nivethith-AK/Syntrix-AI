            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--color-baltic-sea-800)]">
                  ...
                  <th className="p-4 lg:p-6 text-sm font-semibold text-[var(--color-keppel-400)]">Syntrix</th>
                  <th className="p-4 lg:p-6 text-sm font-medium text-[var(--color-baltic-sea-400)]">Notebooks</th>
                  <th className="p-4 lg:p-6 text-sm font-medium text-[var(--color-baltic-sea-400)]">BI tools</th>
                </tr>
              </thead>
              <tbody>
