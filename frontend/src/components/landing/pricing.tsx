...
const PLANS = [
  {
    ...
    price: "Free",
    period: "forever",
    description: "Perfect for portfolio demos and learning the flow",
    features: [
      "Local projects & workspaces",
      "Dataset upload + EDA",
      "Email + Google auth",
      "Experiment tracking",
      "Markdown reports",
  ...
  },
  {
    ...
    price: "$49",
    period: "/month",
    description: "For teams running shared ML workspaces",
    features: [
  ...
  },
  {
    ...
    price: "Custom",
    period: "",
    description: "For orgs that need private deployment",
    features: [
      ...
      <div className="mx-auto max-w-[1400px] px-2.5 sm:px-6 lg:px-12">
        ...
        >
          ...
          <p className="mt-4 text-lg text-[var(--color-baltic-sea-400)]">
            Start with the local demo. Upgrade when you are ready to collaborate.
          </p>
        </div>
