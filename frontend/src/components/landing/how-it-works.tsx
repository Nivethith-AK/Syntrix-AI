...
const STEPS = [
  {
    ...
    description: "Drop a CSV into a project workspace. Syntrix profiles schema, quality, and distributions automatically.",
  },
  {
    icon: GitBranch,
    number: "02",
    title: "Run the AI team",
    description: "Agents handle EDA, training, and explanations while you steer goals and review HITL checkpoints.",
  },
  {
    icon: Rocket,
    number: "03",
    title: "Ship the report",
    description: "Export Markdown + PDF reports, keep model artifacts, and chat with your workspace context.",
  },
]
